...
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"01.nc era5_Uefv_"$((y))"01.nc
...
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"01.nc era5_qb_"$((y))"01.nc
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"02.nc era5_Uefv_"$((y))"02.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"02.nc era5_qb_"$((y))"02.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"03.nc era5_Uefv_"$((y))"03.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"03.nc era5_qb_"$((y))"03.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"04.nc era5_Uefv_"$((y))"04.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"04.nc era5_qb_"$((y))"04.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"05.nc era5_Uefv_"$((y))"05.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"05.nc era5_qb_"$((y))"05.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"06.nc era5_Uefv_"$((y))"06.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"06.nc era5_qb_"$((y))"06.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"07.nc era5_Uefv_"$((y))"07.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"07.nc era5_qb_"$((y))"07.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"08.nc era5_Uefv_"$((y))"08.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"08.nc era5_qb_"$((y))"08.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"09.nc era5_Uefv_"$((y))"09.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"09.nc era5_qb_"$((y))"09.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"10.nc era5_Uefv_"$((y))"10.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"10.nc era5_qb_"$((y))"10.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"11.nc era5_Uefv_"$((y))"11.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"11.nc era5_qb_"$((y))"11.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2310001 era5_Ufv_"$((y))"12.nc era5_Uefv_"$((y))"12.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.231 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.00025 m (25mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.231m/s)
cdo expr,"qb=5*0.231/9.81*1.22/1580*(Uefv*Uefv-0.231*0.231);" era5_Uefv_"$((y))"12.nc era5_qb_"$((y))"12.nc
#mask all azimuths with effective friction velocity, effective friction azimuth

...
#M"$((y))"
cd /home/ligs/Storage/era5_land_hourly/M"$((y))"
...
#delete intermediate result
rm -f era5_land_FP_setmisstoc_timmean_mulc_chname_"$((y))".nc
...
rm -f era5_land_RFP_E_setmisstoc_timmean_mulc_chname_"$((y))".nc
rm -f era5_land_RFP_N_setmisstoc_timmean_mulc_chname_"$((y))".nc
...
rm -f era5_land_qb_ifthen_NNW_setmisstoc_timmean_mulc_chname_"$((y))".nc

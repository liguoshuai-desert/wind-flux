...
#M"$((y))"
cd /home/ligs/Storage/era5_hourly/hourly_wind/M"$((y))"
...
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"01.nc era5_Uefv_"$((y))"01.nc
...
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"01.nc era5_qb_"$((y))"01.nc
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"02.nc era5_Uefv_"$((y))"02.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"02.nc era5_qb_"$((y))"02.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"03.nc era5_Uefv_"$((y))"03.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"03.nc era5_qb_"$((y))"03.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"04.nc era5_Uefv_"$((y))"04.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"04.nc era5_qb_"$((y))"04.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"05.nc era5_Uefv_"$((y))"05.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"05.nc era5_qb_"$((y))"05.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"06.nc era5_Uefv_"$((y))"06.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"06.nc era5_qb_"$((y))"06.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"07.nc era5_Uefv_"$((y))"07.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"07.nc era5_qb_"$((y))"07.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"08.nc era5_Uefv_"$((y))"08.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"08.nc era5_qb_"$((y))"08.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"09.nc era5_Uefv_"$((y))"09.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"09.nc era5_qb_"$((y))"09.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"10.nc era5_Uefv_"$((y))"10.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"10.nc era5_qb_"$((y))"10.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"11.nc era5_Uefv_"$((y))"11.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"11.nc era5_qb_"$((y))"11.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
#mask wind speed ≤ threshold friction velocity, effective friction velocity
cdo -chname,Ufv,Uefv -setrtomiss,0,0.2530001 era5_Ufv_"$((y))"12.nc era5_Uefv_"$((y))"12.nc
#caculate possible bulk-volume flux, qb, where 5 is flux scaling parameter(martin and kok sa), 0.253 m/s is threshold friction velocity(Utfv=sqrt(g*d*rho_s/rho_f)/10, in which g = 9.81 m/s2 is gravity acceleration; d = 0.0003 m (30mm) median grain diameter for surface samples in this study; rho_s=2650kg/m3 is sand density; rho_f=1.22kg/m3 is air density; fianally derive threshold friction velocity Utfv=0.253m/s)
cdo expr,"qb=5*0.253/9.81*1.22/1580*(Uefv*Uefv-0.253*0.253);" era5_Uefv_"$((y))"12.nc era5_qb_"$((y))"12.nc
#mask all azimuths with effective friction velocity, effective friction azimuth
...
cdo -expr,"FP=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_"$((y))".nc era5_FP_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_FP_setmisstoc_timmean_expr_"$((y))".nc era5_FP_"$((y))".nc
#delete intermediate result
rm -f era5_FP_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"RFP_E=qb_E*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_E_"$((y))".nc era5_RFP_E_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_RFP_E_setmisstoc_timmean_expr_"$((y))".nc era5_RFP_E_"$((y))".nc
...
cdo -expr,"RFP_N=qb_N*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_N_"$((y))".nc era5_RFP_N_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_RFP_N_setmisstoc_timmean_expr_"$((y))".nc era5_RFP_N_"$((y))".nc
...
rm -f era5_RFP_E_setmisstoc_timmean_expr_"$((y))".nc
rm -f era5_RFP_N_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"FP_N=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_N_"$((y))".nc era5_qb_ifthen_N_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_N_setmisstoc_timmean_expr_"$((y))".nc era5_FP_N_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_N_"$((y))".nc
rm -f era5_qb_ifthen_N_"$((y))".nc
rm -f era5_qb_ifthen_N_setmisstoc_timmean_expr_"$((y))".nc
#NNE, 11.25≤NNE＜33.75
...
cdo -expr,"FP_NNE=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_NNE_"$((y))".nc era5_qb_ifthen_NNE_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_NNE_setmisstoc_timmean_expr_"$((y))".nc era5_FP_NNE_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_NNE_"$((y))".nc
rm -f era5_qb_ifthen_NNE_"$((y))".nc
rm -f era5_qb_ifthen_NNE_setmisstoc_timmean_expr_"$((y))".nc
#NE, 33.75≤NE＜56.25
...
cdo -expr,"FP_NE=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_NE_"$((y))".nc era5_qb_ifthen_NE_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_NE_setmisstoc_timmean_expr_"$((y))".nc era5_FP_NE_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_NE_"$((y))".nc
rm -f era5_qb_ifthen_NE_"$((y))".nc
rm -f era5_qb_ifthen_NE_setmisstoc_timmean_expr_"$((y))".nc
#ENE, 56.25≤ENE＜78.75
...
cdo -expr,"FP_ENE=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_ENE_"$((y))".nc era5_qb_ifthen_ENE_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_ENE_setmisstoc_timmean_expr_"$((y))".nc era5_FP_ENE_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_ENE_"$((y))".nc
rm -f era5_qb_ifthen_ENE_"$((y))".nc
rm -f era5_qb_ifthen_ENE_setmisstoc_timmean_expr_"$((y))".nc
#E, 78.75≤E＜101.25
...
cdo -expr,"FP_E=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_E_"$((y))".nc era5_qb_ifthen_E_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_E_setmisstoc_timmean_expr_"$((y))".nc era5_FP_E_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_E_"$((y))".nc
rm -f era5_qb_ifthen_E_"$((y))".nc
rm -f era5_qb_ifthen_E_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"FP_ESE=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_ESE_"$((y))".nc era5_qb_ifthen_ESE_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_ESE_setmisstoc_timmean_expr_"$((y))".nc era5_FP_ESE_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_ESE_"$((y))".nc
rm -f era5_qb_ifthen_ESE_"$((y))".nc
rm -f era5_qb_ifthen_ESE_setmisstoc_timmean_expr_"$((y))".nc
#SE, 123.75≤SE＜146.25
...
cdo -expr,"FP_SE=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_SE_"$((y))".nc era5_qb_ifthen_SE_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_SE_setmisstoc_timmean_expr_"$((y))".nc era5_FP_SE_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_SE_"$((y))".nc
rm -f era5_qb_ifthen_SE_"$((y))".nc
rm -f era5_qb_ifthen_SE_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"FP_SSE=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_SSE_"$((y))".nc era5_qb_ifthen_SSE_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_SSE_setmisstoc_timmean_expr_"$((y))".nc era5_FP_SSE_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_SSE_"$((y))".nc
rm -f era5_qb_ifthen_SSE_"$((y))".nc
rm -f era5_qb_ifthen_SSE_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"FP_S=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_S_"$((y))".nc era5_qb_ifthen_S_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_S_setmisstoc_timmean_expr_"$((y))".nc era5_FP_S_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setrtomiss_S_"$((y))".nc
rm -f era5_qb_ifthen_S_"$((y))".nc
rm -f era5_qb_ifthen_S_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"FP_SSW=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_SSW_"$((y))".nc era5_qb_ifthen_SSW_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_SSW_setmisstoc_timmean_expr_"$((y))".nc era5_FP_SSW_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_SSW_"$((y))".nc
rm -f era5_qb_ifthen_SSW_"$((y))".nc
rm -f era5_qb_ifthen_SSW_setmisstoc_timmean_expr_"$((y))".nc
#SW, -146.25≤SW＜-123.75
...
cdo -expr,"FP_SW=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_SW_"$((y))".nc era5_qb_ifthen_SW_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_SW_setmisstoc_timmean_expr_"$((y))".nc era5_FP_SW_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_SW_"$((y))".nc
rm -f era5_qb_ifthen_SW_"$((y))".nc
rm -f era5_qb_ifthen_SW_setmisstoc_timmean_expr_"$((y))".nc
...
cdo -expr,"FP_WSW=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_WSW_"$((y))".nc era5_qb_ifthen_WSW_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_WSW_setmisstoc_timmean_expr_"$((y))".nc era5_FP_WSW_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_WSW_"$((y))".nc
rm -f era5_qb_ifthen_WSW_"$((y))".nc
rm -f era5_qb_ifthen_WSW_setmisstoc_timmean_expr_"$((y))".nc
#W, -101.25≤W＜-78.75
...
cdo -expr,"FP_W=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_W_"$((y))".nc era5_qb_ifthen_W_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_W_setmisstoc_timmean_expr_"$((y))".nc era5_FP_W_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_W_"$((y))".nc
rm -f era5_qb_ifthen_W_"$((y))".nc
rm -f era5_qb_ifthen_W_setmisstoc_timmean_expr_"$((y))".nc
#WNW, -78.75≤WNW＜-56.25
...
cdo -expr,"FP_WNW=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_WNW_"$((y))".nc era5_qb_ifthen_WNW_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_WNW_setmisstoc_timmean_expr_"$((y))".nc era5_FP_WNW_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_WNW_"$((y))".nc
rm -f era5_qb_ifthen_WNW_"$((y))".nc
rm -f era5_qb_ifthen_WNW_setmisstoc_timmean_expr_"$((y))".nc
#NW, -56.25≤NW＜-33.75
...
cdo -expr,"FP_NW=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_NW_"$((y))".nc era5_qb_ifthen_NW_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_NW_setmisstoc_timmean_expr_"$((y))".nc era5_FP_NW_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_NW_"$((y))".nc
rm -f era5_qb_ifthen_NW_"$((y))".nc
rm -f era5_qb_ifthen_NW_setmisstoc_timmean_expr_"$((y))".nc
#NNW, -33.75≤NNW＜-11.25
...
cdo -expr,"FP_NNW=qb*$ydays*24*60*60;" -timmean -setmisstoc,0 era5_qb_ifthen_NNW_"$((y))".nc era5_qb_ifthen_NNW_setmisstoc_timmean_expr_"$((y))".nc
cdo ifthen era5_hourly_10m_u_component_of_wind_"$((y))"01.nc era5_qb_ifthen_NNW_setmisstoc_timmean_expr_"$((y))".nc era5_FP_NNW_"$((y))".nc
#delete intermediate result
rm -f era5_qa_setvrange_NNW_"$((y))".nc
rm -f era5_qb_ifthen_NNW_"$((y))".nc
rm -f era5_qb_ifthen_NNW_setmisstoc_timmean_expr_"$((y))".nc
